...
Below are two extra visualizations that offer further insights into the dataset.

### 4.1 Custom Interactive Plot with Enhanced Dimensions

In this example, we adjust the interactive plot’s dimensions and use a custom colour scheme to improve clarity when examining the multivariate data.
...
### 4.2 Static Parallel Coordinates Plot with Custom Theme
