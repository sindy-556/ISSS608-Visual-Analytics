...
```{r}
n_yes <- sum(train_data$Heart_Attack_Occurrence == "Yes")
n_no  <- sum(train_data$Heart_Attack_Occurrence == "No")
N     <- n_yes + n_no
...
# Assign weights
train_data$weights_col <- ifelse(
  train_data$Heart_Attack_Occurrence == "Yes",
  w_yes,
  w_no
)
```
